...
$api->onGET('departures', '/{profile}/departures/{query}', new Blue\TrainsearchApi\Handler\ArrivalsHandler());
$api->onGET('arrivals', '/{profile}/arrivals/{query}', new Blue\TrainsearchApi\Handler\DeparturesHandler());
